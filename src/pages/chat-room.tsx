...
const privateChat: Chat = {
    unreadCount: 0,
    id: 1, createdAt: Date.now(), type: ChatType.PrivateChat, privateChat: {type: ChatType.PrivateChat, participants: [{id: 1, name: 'Alice', profilePicture: 'https://images.freeimages.com/images/large-previews/fdd/man-avatar-1632964.jpg?fmt=webp&h=500', phoneNumber: '123-456-7890', email: 'alice@example.com', about: 'A passionate developer.'}, {id: 2, name: 'Bob', profilePicture: 'https://images.freeimages.com/images/large-previews/fdd/man-avatar-1632964.jpg?fmt=webp&h=500', phoneNumber: '987-654-3210', email: 'bob@example.com', about: 'A tech enthusiast.'}], lastSeen: Date.now(), lastMessage: {
            id: 1,
            user: {
                about: "",
                email: "",
...
const ChatRoom = ({chat = privateChat}: { chat?: Chat }) => {
    ...
    const current: User = {
        about: "", email: "", phoneNumber: "", profilePicture: "", id: 1, name: "Hilmi Raif"
    }
                                    ...
                                    return (
                                        <div key={message.id}
                                            ...
                                            <div ref={(el) => {
                                                ...
                                                {isCurrentUser && (
                                                    <div
                                                        className="self-stretch shrink-0 size-14 flex h-full items-center justify-center ">
                                                        <div className="flex items-center justify-center group min-h-[63.200px]">
                                                            <Button
                                                                size={"icon"}
                                                ...
                                                {!isCurrentUser && (
                                                    <div
                                                        className="self-stretch shrink-0 size-10 flex h-full items-center justify-center pl-[3px]">
                                                        <Button
                                                            variant={"ghost"}
                                                            size={"icon"}
